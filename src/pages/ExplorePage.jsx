  ...
  return (
    <main className="explore-reference-page">
      <div className="explore-dynamic-bg" aria-hidden="true">
        ...
        <span className="explore-aurora-wave explore-aurora-wave-mid"></span>
        <span className="explore-aurora-wave explore-aurora-wave-bottom"></span>
        ...
        <span className="explore-pulse-ring explore-pulse-ring-three"></span>
        <span className="explore-pulse-ring explore-pulse-ring-four"></span>
